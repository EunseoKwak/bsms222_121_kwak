...
차이를 조금 더 잘 비교할 수 있도록 y axis에 scale_y_log10을 적용했고, 위와 같은 방식으로 geom_jitter, stat_summary를 사용해 점을 통해 median, 선을 통해 median들의 평균을 나타냈다. 이후 theme_light, ggtitle, labs, themes 함수를 이용해 그래프의 aesthetics를 다뤘다.
